...
<body>
          ...
          <div class="col-12 col-md-6 h-100 bg-white">
            <div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
              <form action="#">
                ...
                <div class="form-group">
                <button type="submit" class="btn btn-info btn-fw btn-padding" id="btnlogin">SIGN IN </button>
                  <!-- <a href="signin" class="btn btn-info btn-fw btn-padding">SIGN IN</a> -->
  ...
  <script src="${currentContextPath}/efive/jspJs/index.js"></script>
  <script>
